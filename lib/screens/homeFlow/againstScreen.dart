...
class AgainstScreen extends StatefulWidget {
  const AgainstScreen({super.key});

  @override
  State<AgainstScreen> createState() => _AgainstScreenState();
}

class _AgainstScreenState extends State<AgainstScreen> {
  @override
